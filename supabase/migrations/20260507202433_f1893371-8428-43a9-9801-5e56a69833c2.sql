-- Add faculty (college/major) column to profiles for students
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS faculty text;

-- Update handle_new_user trigger to read occupation_status, university, faculty, job_title from signup metadata
