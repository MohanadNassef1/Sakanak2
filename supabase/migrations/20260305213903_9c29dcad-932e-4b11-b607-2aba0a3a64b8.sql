...
BEGIN
  ...
  IF NEW.description IS NOT NULL AND (
    NEW.description ~* '\m01[0125]' OR
    NEW.description ~* '0[.,\-_|/\\:;*#+=~]+1[.,\-_|/\\:;*#+=~]+[0125]' OR
    NEW.description ~* '(\+|00)20[^a-zA-Z]*1[0125]' OR
  ...
  IF NEW.title IS NOT NULL AND (
    NEW.title ~* '\m01[0125]' OR
    NEW.title ~* '0[.,\-_|/\\:;*#+=~]+1[.,\-_|/\\:;*#+=~]+[0125]' OR
    NEW.title ~* '(\+|00)20[^a-zA-Z]*1[0125]' OR
  ...
  IF NEW.address IS NOT NULL AND (
    NEW.address ~* '\m01[0125]' OR
    NEW.address ~* '0[.,\-_|/\\:;*#+=~]+1[.,\-_|/\\:;*#+=~]+[0125]' OR
    NEW.address ~* '(\+|00)20[^a-zA-Z]*1[0125]' OR
