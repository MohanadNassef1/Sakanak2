          ...
          <tr>
            <td align="center" style="padding: 32px 40px 24px 40px; border-bottom: 1px solid ${BORDER_LIGHT};">
              <a href="https://sakanakeg.com" target="_blank" style="text-decoration: none;">
                <img src="https://lmjivfayjyskriikcyzg.supabase.co/storage/v1/object/public/email-assets/sakanak-logo-transparent.png" alt="Sakanak" width="160" style="display: block; margin: 0 auto; max-width: 160px; height: auto;" />
              </a>
