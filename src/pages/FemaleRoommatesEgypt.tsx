  ...
  <SEOLandingTemplate
    ...
    faqs={{
      ...
      ar: [
        ...
        { q: 'إزاي أتأكد إن باقي البنات حقيقيات؟', a: 'مش بنطلب أي صور بطاقة أو جواز سفر. كل حساب بيتأكد بالبريد الإلكتروني ورقم الهاتف، وفريقنا بيراجع الإعلانات والبلاغات باستمرار.' },
