...
const StudentHousingEgypt: React.FC = () => (
  <SEOLandingTemplate
    ...
    faqs={{
      ...
      ar: [
        { q: 'هل سكن الطلاب على سكنك موثق؟', a: 'أيوه. مش بنطلب صور بطاقة أو جواز سفر؛ الحسابات بتتأكد بالبريد الإلكتروني ورقم الهاتف، وكتير من الطلاب بيستخدموا إيميل الجامعة .edu علشان شارة ثقة إضافية.' },
